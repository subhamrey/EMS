<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="EMS_UI.Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2 class="text-center">Edit Employee</h2>
    <p>Enter Employee ID :
        <asp:TextBox ID="TextBoxEmpID" runat="server" Height="16px" Width="93px" ValidationGroup="SearchGroup"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="ButtonGetEmpData" runat="server" CssClass="btn btn-info" Height="34px" OnClick="ButtonGetEmpData_Click" Text="Search" Width="138px" ValidationGroup="SearchGroup" />
&nbsp;&nbsp;&nbsp;
        <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ErrorMessage="RequiredFieldValidator" Font-Bold="True" Font-Size="Medium" ForeColor="Red" ControlToValidate="TextBoxEmpID" ValidationGroup="SearchGroup">Emp ID required !</asp:RequiredFieldValidator>
    </p>
      <table style="margin:1px">
        ...
        <tr>
         ...
         <tr>
            <td></td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="ButtonCancel" runat="server" CssClass="btn btn-danger" Text="Cancel" CausesValidation="False" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="ButtonUpdate" runat="server" Text="Update" CssClass="btn btn-success" OnClick="ButtonSubmit_Click" ValidationGroup="UpdateGroup" />
             </td>
            <td>&nbsp;</td>
        </tr>
    </table>
